...
export default function TermsPage() {
  return (
    <div>
      ...
      <CardBody>
        <p>Overview
These Terms of Use apply to the website of ModelAI Inc. (the “Company”) at www.modelai.net and its various associated web pages, applications, and website-related services (the “Site”).
...
These Terms of Use constitute the entire agreement between the parties with respect to the subject matter contained in these Terms of Use, except as other provisions or terms have been incorporated by reference herein, and supersede all prior correspondence, discussions, agreements, and understandings entered into between the Company and You, whether written or oral, with respect to such subject matter.</p>
      </CardBody>
      <Divider/>
      <CardFooter>
        <Link
